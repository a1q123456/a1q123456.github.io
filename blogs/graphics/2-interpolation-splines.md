...
The above figure is generate by the following Matlab function. There is a sharp corner on $x = 3$, because the point 2 and the point 4 are not on the same line, in this case, the point 3 has two tangent lines which causes the sharp corner.
